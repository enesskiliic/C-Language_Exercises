...
int canTileByArea(double, double, int, double, double);
...
int canTileByArea(double a, double b, int n, double x, double y){
    return (a * b * n == x * y) ? 1 : 0;
}
...
int main() {
    ...
    assertEqualInt(canTileByArea(2.0, 3.0, 4, 3.0, 8.0), 1, "canTileByArea areas equal", t++);
    assertEqualInt(canTileByArea(2.0, 3.0, 3, 3.0, 8.0), 0, "canTileByArea areas not equal", t++);
    assertEqualInt(canTileByArea(-2.0, 3.0, 4, 3.0, 8.0), 0, "canTileByArea invalid small", t++);
